...
<%@ page import="com.apple.po.CourseInfo" %>
<%
				    		...
				    		<div class="row">
				    			<div class="col-md-12 top5">
				    				...
				    				<table class="table table-condensed table-hover">
				    					<tr class="success bold"><td>序号</td><td>记录编号</td><td>课程简介</td><td>课程大纲</td><td>操作</td></tr>
				    					<% 
				    						/*计算起始序号*/
 										...
 										<tr>
 											<td><%=currentIndex %></td>
 											<td><%=courseInfo.getId() %></td>
 											<td><%=courseInfo.getJianjie() %></td>
 											<td><%=courseInfo.getDagan() %></td>
 											<td>
 												<a href="<%=basePath  %>CourseInfo/<%=courseInfo.getId() %>/frontshow"><i class="fa fa-info"></i>&nbsp;查看</a>&nbsp;
 												<a href="#" onclick="courseInfoEdit('<%=courseInfo.getId() %>');" style="display:none;"><i class="fa fa-pencil fa-fw"></i>编辑</a>&nbsp;
 												<a href="#" onclick="courseInfoDelete('<%=courseInfo.getId() %>');" style="display:none;"><i class="fa fa-trash-o fa-fw"></i>删除</a>
 											</td> 
 										</tr>
 										<%}%>
				    				</table>
